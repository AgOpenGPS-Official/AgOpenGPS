...
namespace AgOpenGPS
{
    ...
    public partial class FormGPS
    {
        ...
        private void HandleButtonHardware()
        {
            ...
            if (tool.isSectionsNotZones)  // NO Zones
            {
                if (mc.ss[mc.swOnGr0] != 0)
                {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        if (((mc.ss[mc.swOnGr0] & (1 << i)) != 0) && (tool.numOfSections > i))
                        {
                ...
                if (mc.ss[mc.swOnGr1] != 0)
                {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        if (((mc.ss[mc.swOnGr1] & (1 << i)) != 0) && (tool.numOfSections > i + 8))
                        {
                ...
                if (mc.ss[mc.swOffGr0] != mc.ssP[mc.swOffGr0])
                {
                    ...
                    if (autoBtnState == btnStates.Auto)
                    {
                        for (int i = 0; i < 8; i++)
                        {
                            if (((mc.ssP[mc.swOffGr0] & (1 << i)) != 0) && ((mc.ss[mc.swOffGr0] & (1 << i)) != 1) && (section[i].sectionBtnState == btnStates.Off))
                            {
                                PerformSectionClick(i);
                            }
                        }
                ...
                if (mc.ss[mc.swOffGr1] != mc.ssP[mc.swOffGr1])
                {
                    ...
                    if (autoBtnState == btnStates.Auto)
                    {
                        for (int i = 0; i < 8; i++)
                        {
                            if (((mc.ssP[mc.swOffGr1] & (1 << i)) != 0) && ((mc.ss[mc.swOffGr1] & (1 << i)) != 1) && (section[i + 8].sectionBtnState == btnStates.Off))
                            {
                                PerformSectionClick(i + 8);
                            }
                        }
                ...
                if (mc.ss[mc.swOffGr0] != 0)
                {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        if (((mc.ss[mc.swOffGr0] & (1 << i)) != 0) && (section[i].sectionBtnState != btnStates.Off))
                        {
                ...
                if (mc.ss[mc.swOffGr1] != 0)
                {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        if (((mc.ss[mc.swOffGr1] & (1 << i)) != 0) && (section[i + 8].sectionBtnState != btnStates.Off))
                        {
            ...
            else// zones to on
            {
                if (mc.ss[mc.swOnGr0] != 0)
                {
                    for (int i = 0; i < 8; i++)
                    {
                        if ((tool.zoneRanges[i + 1] > 0) && ((mc.ss[mc.swOnGr0] & (1 << i)) != 0))
                        {
                ...
                if (mc.ss[mc.swOffGr0] != mc.ssP[mc.swOffGr0])
                {
                    if (autoBtnState == btnStates.Auto)
                    {
                        for (int i = 0; i < 8; i++)
                        {
                            if ((tool.zoneRanges[i + 1] > 0) && ((mc.ssP[mc.swOffGr0] & (1 << i)) != 0) && ((mc.ss[mc.swOffGr0] & (1 << i)) != 1) && (section[tool.zoneRanges[i + 1] - 1].sectionBtnState == btnStates.Off))
                            {
                                PerformZoneClick(i);
                            }
                        }
                ...
                if (mc.ss[mc.swOffGr0] != 0)
                {
                    for (int i = 0; i < 8; i++)
                    {
                        if ((tool.zoneRanges[i + 1] > 0) && ((mc.ss[mc.swOffGr0] & (1 << i)) != 0) && (section[tool.zoneRanges[i + 1] - 1].sectionBtnState != btnStates.Off))
                        {
        ...
        {
            //MainSW Byte is AUTO
            if ((autoBtnState != btnStates.Auto) && ((mc.ss[mc.swMain] & 1) != 0))
            {
                //set butto off and then press it = ON
                autoBtnState = btnStates.Off;
                btnSectionMasterAuto.PerformClick();
            ...
            //MainSW Byte is OFF
            else if ((autoBtnState != btnStates.Off) && ((mc.ss[mc.swMain] & (1 << 1)) != 0))
            {
                //set button on and then press it = OFF
                autoBtnState = btnStates.Auto;
                btnSectionMasterAuto.PerformClick();
            ...
            if (tool.isSectionsNotZones) // NO Zones
            {
                if (mc.ss[mc.swAutoGr0] != 0)
                {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        if ((section[i].sectionBtnState != btnStates.Auto) && ((mc.ss[mc.swAutoGr0] & (1 << i)) != 0) && (tool.numOfSections > i) && (mc.ss[mc.swNumSections] > i))
                        {
                ...
                if (mc.ss[mc.swAutoGr1] != 0)
                {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        if ((section[i + 8].sectionBtnState != btnStates.Auto) && ((mc.ss[mc.swAutoGr1] & (1 << i)) != 0) && (tool.numOfSections > i + 8) && (mc.ss[mc.swNumSections] > i + 8))
                        {
                            PerformSectionClick(i + 8);
                        }
                    }
                ...
                if (mc.ss[mc.swOnGr0] != 0)
                {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        if (((section[i].sectionBtnState != btnStates.On) && (mc.ss[mc.swOnGr0] & (1 << i)) != 0) && (tool.numOfSections > i) && (mc.ss[mc.swNumSections] > i))
                        {
                            section[i].sectionBtnState = btnStates.Auto;
                            PerformSectionClick(i);
                        }
                ...
                if (mc.ss[mc.swOnGr1] != 0)
                {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        if ((section[i + 8].sectionBtnState != btnStates.On) && ((mc.ss[mc.swOnGr1] & (1 << i)) != 0) && (tool.numOfSections > i + 8) && (mc.ss[mc.swNumSections] > i + 8))
                        {
                            section[i + 8].sectionBtnState = btnStates.Auto;
                            PerformSectionClick(i + 8);
                        }
                ...
                if (mc.ss[mc.swOffGr0] != 0)
                {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        if ((section[i].sectionBtnState != btnStates.Off) && ((mc.ss[mc.swOffGr0] & (1 << i)) != 0) && (tool.numOfSections > i))  // !check mc.ss[tool.numOfSections] => to be on the save side by switching eveything off 
                        {
                            section[i].sectionBtnState = btnStates.On;
                            PerformSectionClick(i);
                        }
                ...
                if (mc.ss[mc.swOffGr1] != 0)
                {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        if ((section[i + 8].sectionBtnState != btnStates.Off) && ((mc.ss[mc.swOffGr1] & (1 << i)) != 0) && (tool.numOfSections > i + 8)) // !check mc.ss[tool.numOfSections] => to be on the save side by switching eveything off
                        {
                            PerformSectionClick(i + 8);
                        }
                    }
            ...
            else
            {
                ...
                if (mc.ss[mc.swAutoGr0] != 0)
                {
                    for (int i = 0; i < 8; i++)
                    {
                        if ((tool.zoneRanges[i + 1] > 0) && ((mc.ss[mc.swAutoGr0] & (1 << i)) != 0) && ((mc.ss[mc.swOnGr0] & (1 << i)) != 1) && ((mc.ss[mc.swOffGr0] & (1 << i)) != 1) && (section[tool.zoneRanges[i + 1] - 1].sectionBtnState != btnStates.Auto))
                        {
                ...
                if (mc.ss[mc.swOnGr0] != 0)
                {
                    for (int i = 0; i < 8; i++)
                    {
                        if ((tool.zoneRanges[i + 1] > 0) && ((mc.ss[mc.swOnGr0] & (1 << i)) != 0) && ((mc.ss[mc.swOffGr0] & (1 << i)) != 1) && (section[tool.zoneRanges[i + 1] - 1].sectionBtnState != btnStates.On))
                        {
                            section[tool.zoneRanges[i + 1] - 1].sectionBtnState = btnStates.Auto;
                            PerformZoneClick(i);
