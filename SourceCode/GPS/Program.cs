...
namespace AgOpenGPS
{
    internal static class Program
    {
        ...
        public static readonly string Version = Assembly.GetEntryAssembly()?.GetName().Version.ToString(3) ?? "0.0.0"; // Major.Minor.Patch
        public static readonly string SemVer = (Application.ProductVersion ?? "0.0.0").Split('+').First();
